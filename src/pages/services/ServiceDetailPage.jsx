...
export default function ServiceDetailPage() {
  ...
  return (
    <>
      ...
      <section className="relative min-h-[440px] overflow-hidden pt-32 pb-20 md:min-h-[520px]">
        ...
        <div className="container-custom relative z-10">
          ...
          >
            ...
            <h1 className="font-heading text-4xl font-bold text-white drop-shadow-sm sm:text-5xl">{service.title}</h1>
            <p className="mt-4 max-w-2xl text-lg leading-relaxed text-white/90">{service.description}</p>
            <Button to="/contact" variant="white" className="mt-8" icon={Calendar}>Book Free Consultation</Button>
          </motion.div>
        </div>
      </section>
